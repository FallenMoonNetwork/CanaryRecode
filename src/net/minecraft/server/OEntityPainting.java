...
public class OEntityPainting extends OEntity {
   ...
   public void b(int var1) {
      ...
      this.c((double)var5, (double)var6, (double)var7);
      float var9 = -0.00625F;
      this.bw.c((double)(var5 - var2 - var9), (double)(var6 - var3 - var9), (double)(var7 - var4 - var9), (double)(var5 + var2 + var9), (double)(var6 + var3 + var9), (double)(var7 + var4 + var9));
   }
   ...
   public void F_() {
      if(this.f++ == 100 && !this.bi.F) {
         ...
         if(!this.bE && !this.k()) {
            this.X();
            this.bi.b((OEntity)(new OEntityItem(this.bi, this.bm, this.bn, this.bo, new OItemStack(OItem.ar))));
         }
      }
   ...
   public boolean k() {
      if(this.bi.a((OEntity)this, this.bw).size() > 0) {
         return false;
      } else {
         ...
         int var5 = this.d;
         if(this.a == 0) {
            var3 = OMathHelper.b(this.bm - (double)((float)this.e.B / 32.0F));
         }

         if(this.a == 1) {
            var5 = OMathHelper.b(this.bo - (double)((float)this.e.B / 32.0F));
         }
         ...
         var4 = OMathHelper.b(this.bn - (double)((float)this.e.C / 32.0F));
         ...
         List var9 = this.bi.b((OEntity)this, this.bw);
