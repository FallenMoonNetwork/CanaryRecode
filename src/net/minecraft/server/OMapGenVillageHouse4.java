...
public class OMapGenVillageHouse4 extends OMapGenVillageStructureGen {

   private int a = -1;
   private final boolean b;


   public OMapGenVillageHouse4(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   ...
   public static OMapGenVillageHouse4 a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, 0, 0, 0, 5, 6, 5, var5);
      return OStructurePiece.a(var0, var7) != null?null:new OMapGenVillageHouse4(var6, var1, var7, var5);
   }
