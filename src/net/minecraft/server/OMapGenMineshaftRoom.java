...
public class OMapGenMineshaftRoom extends OStructurePiece {

   private LinkedList a = new LinkedList();


   public OMapGenMineshaftRoom(int var1, Random var2, int var3, int var4) {
      super(var1);
   ...
   public void a(OStructurePiece var1, List var2, Random var3) {
      ...
      for(var6 = 0; var6 < this.g.b(); var6 += 4) {
         ...
         var7 = OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + var6, this.g.b + var3.nextInt(var5) + 1, this.g.c - 1, 2, var4);
         if(var7 != null) {
            var8 = var7.b();
      ...
      for(var6 = 0; var6 < this.g.b(); var6 += 4) {
         ...
         var7 = OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + var6, this.g.b + var3.nextInt(var5) + 1, this.g.f + 1, 0, var4);
         if(var7 != null) {
            var8 = var7.b();
      ...
      for(var6 = 0; var6 < this.g.d(); var6 += 4) {
         ...
         var7 = OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b + var3.nextInt(var5) + 1, this.g.c + var6, 1, var4);
         if(var7 != null) {
            var8 = var7.b();
      ...
      for(var6 = 0; var6 < this.g.d(); var6 += 4) {
         ...
         var7 = OMapGenMineshaftPieces.a(var1, var2, var3, this.g.d + 1, this.g.b + var3.nextInt(var5) + 1, this.g.c + var6, 3, var4);
         if(var7 != null) {
            var8 = var7.b();
