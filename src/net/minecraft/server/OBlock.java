...
import net.minecraft.server.OBlockPlanks;
...
import net.minecraft.server.OBlockWallSign;
import net.minecraft.server.OBlockWaterlily;
...
public class OBlock {
   ...
   public static final OBlock x = (new OBlockPlanks(5)).c(2.0F).b(5.0F).a(e).a("wood").j();
   ...
   public static final OBlock aD = (new OBlockWallSign(63, OTileEntitySign.class, true)).c(1.0F).a(e).a("sign").s().j();
   ...
   public static final OBlock aI = (new OBlockWallSign(68, OTileEntitySign.class, false)).c(1.0F).a(e).a("sign").s().j();
   ...
   public static final OBlock bz = (new OBlockWaterlily(111, 76)).c(0.0F).a(g).a("waterlily");
   ...
   public static final OBlock bH = (new OBlockEnderPortal(119, OMaterial.B)).c(-1.0F).b(6000000.0F);
   ...
   protected void a(OWorld var1, int var2, int var3, int var4, OItemStack var5) {
      if(!var1.F) {
         ...
         OEntityItem var13 = new OEntityItem(var1, (double)var2 + var7, (double)var3 + var9, (double)var4 + var11, var5);
         var13.c = 10;
         var1.b((OEntity)var13);
      }
   }
   ...
   public OMovingObjectPosition a(OWorld var1, int var2, int var3, int var4, OVec3D var5, OVec3D var6) {
      ...
      if(var13 == null) {
         ...
         return new OMovingObjectPosition(var2, var3, var4, var14, var13.c((double)var2, (double)var3, (double)var4));
      }
   }
