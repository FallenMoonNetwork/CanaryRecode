...
public class OMapGenVillageLandscapeManager extends OGenLayer {

   private OBiomeGenBase[] b;


   public OMapGenVillageLandscapeManager(long var1, OGenLayer var3, OEnumWorldType var4) {
      super(var1);
