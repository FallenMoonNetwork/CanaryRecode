...
abstract class OMapGenStrongholdPiece extends OStructurePiece {

   protected OMapGenStrongholdPiece(int var1) {
      super(var1);
   }
   ...
   protected OStructurePiece a(OMapGenStrongholdStairs2 var1, List var2, Random var3, int var4, int var5) {
      switch(this.h) {
      case 0:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a + var4, this.g.b + var5, this.g.f + 1, this.h, this.c());
      case 1:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a - 1, this.g.b + var5, this.g.c + var4, this.h, this.c());
      case 2:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a + var4, this.g.b + var5, this.g.c - 1, this.h, this.c());
      case 3:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.d + 1, this.g.b + var5, this.g.c + var4, this.h, this.c());
      default:
         return null;
      }
   }

   protected OStructurePiece b(OMapGenStrongholdStairs2 var1, List var2, Random var3, int var4, int var5) {
      switch(this.h) {
      case 0:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a - 1, this.g.b + var4, this.g.c + var5, 1, this.c());
      case 1:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a + var5, this.g.b + var4, this.g.c - 1, 2, this.c());
      case 2:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a - 1, this.g.b + var4, this.g.c + var5, 1, this.c());
      case 3:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a + var5, this.g.b + var4, this.g.c - 1, 2, this.c());
   ...
   protected OStructurePiece c(OMapGenStrongholdStairs2 var1, List var2, Random var3, int var4, int var5) {
      switch(this.h) {
      case 0:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.d + 1, this.g.b + var4, this.g.c + var5, 3, this.c());
      case 1:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a + var5, this.g.b + var4, this.g.f + 1, 0, this.c());
      case 2:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.d + 1, this.g.b + var4, this.g.c + var5, 3, this.c());
      case 3:
         return OMapGenStrongholdPieces.a(var1, var2, var3, this.g.a + var5, this.g.b + var4, this.g.f + 1, 0, this.c());
