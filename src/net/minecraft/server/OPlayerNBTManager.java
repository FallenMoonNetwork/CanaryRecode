...
public class OPlayerNBTManager implements OIPlayerFileData, OISaveHandler {
   ...
   public OWorldInfo c() {
      ...
      if(var1.exists()) {
         try {
            var2 = OCompressedStreamTools.a((InputStream)(new FileInputStream(var1)));
            var3 = var2.m("Data");
   ...
   public void a(OWorldInfo var1, List var2) {
      ...
      try {
         ...
         OCompressedStreamTools.a(var4, (OutputStream)(new FileOutputStream(var5)));
         if(var6.exists()) {
            var6.delete();
         }
   ...
   public void a(OWorldInfo var1) {
      ...
      try {
         ...
         OCompressedStreamTools.a(var3, (OutputStream)(new FileOutputStream(var4)));
         if(var5.exists()) {
            var5.delete();
         }
   ...
   public void a(OEntityPlayer var1) {
      try {
         ...
         OCompressedStreamTools.a(var2, (OutputStream)(new FileOutputStream(var3)));
         if(var4.exists()) {
            var4.delete();
         }
   ...
   public ONBTTagCompound a(String var1) {
      try {
         ...
         if(var2.exists()) {
            return OCompressedStreamTools.a((InputStream)(new FileInputStream(var2)));
         }
