...
public class OCompressedStreamTools {
   ...
   public static ONBTTagCompound a(InputStream var0) throws IOException {
    ...
    try {
        var1 = new DataInputStream(new BufferedInputStream(new GZIPInputStream(var0)));
   ...
   public static void a(ONBTTagCompound var0, OutputStream var1) throws IOException {
    ...
    try {
        var2 = new DataOutputStream(new GZIPOutputStream(var1));
    } catch (IOException e) {
        // TODO Auto-generated catch block
        e.printStackTrace();
    }
   ...
   public static ONBTTagCompound a(byte[] var0) throws IOException {
      DataInputStream var1 = null;
    try {
        var1 = new DataInputStream(new BufferedInputStream(new GZIPInputStream(new ByteArrayInputStream(var0))));
    } catch (IOException e1) {
        // TODO Auto-generated catch block
        e1.printStackTrace();
    }
