...
public class OBlockTNT extends OBlock {
   ...
   public void a_(OWorld var1, int var2, int var3, int var4) {
      if(!var1.F) {
         OEntityTNTPrimed var5 = new OEntityTNTPrimed(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F));
   ...
   public void c(OWorld var1, int var2, int var3, int var4, int var5) {
      if(!var1.F) {
         if((var5 & 1) == 0) {
            ...
            OEntityTNTPrimed var6 = new OEntityTNTPrimed(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F));
            var1.b((OEntity)var6);
