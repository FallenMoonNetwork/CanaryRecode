...
public abstract class OEntityAnimal extends OEntityAgeable implements OIAnimals {
   ...
   public void e() {
      ...
      if(this.a > 0) {
         ...
         if(this.a % 10 == 0) {
            ...
            this.bi.a(var1, this.bm + (double)(this.bS.nextFloat() * this.bG * 2.0F) - (double)this.bG, this.bn + 0.5D + (double)(this.bS.nextFloat() * this.bH), this.bo + (double)(this.bS.nextFloat() * this.bG * 2.0F) - (double)this.bG, var2, var4, var6);
         }
      } else {
         this.b = 0;
      }
   ...
   protected void a(OEntity var1, float var2) {
      if(var1 instanceof OEntityPlayer) {
         ...
         if(this.K() > 0 && var8.K() < 0) {
            ...
            if(var8.d == this && (double)var2 < 3.5D) {
               ++var8.a;
               ++this.a;
               ++this.b;
               if(this.b % 4 == 0) {
                  this.bi.a("heart", this.bm + (double)(this.bS.nextFloat() * this.bG * 2.0F) - (double)this.bG, this.bn + 0.5D + (double)(this.bS.nextFloat() * this.bH), this.bo + (double)(this.bS.nextFloat() * this.bG * 2.0F) - (double)this.bG, 0.0D, 0.0D, 0.0D);
               }
   ...
   private void c(OEntityAnimal var1) {
      ...
      if(var2 != null) {
         ...
         for(int var3 = 0; var3 < 7; ++var3) {
            ...
            this.bi.a("heart", this.bm + (double)(this.bS.nextFloat() * this.bG * 2.0F) - (double)this.bG, this.bn + 0.5D + (double)(this.bS.nextFloat() * this.bH), this.bo + (double)(this.bS.nextFloat() * this.bG * 2.0F) - (double)this.bG, var4, var6, var8);
         }
   ...
   protected OEntity o() {
      if(this.f > 0) {
         ...
         OEntityAnimal var4;
         if(this.a > 0) {
            var2 = this.bi.a(this.getClass(), this.bw.b((double)var1, (double)var1, (double)var1));
            ...
            var2 = this.bi.a(OEntityPlayer.class, this.bw.b((double)var1, (double)var1, (double)var1));
