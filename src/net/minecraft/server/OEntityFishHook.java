...
public class OEntityFishHook extends OEntity {
   ...
   public OEntityFishHook(OWorld var1, OEntityPlayer var2) {
      ...
      this.b.R = this;
      this.b(0.25F, 0.25F);
      this.c(var2.bm, var2.bn + 1.62D - (double)var2.bF, var2.bo, var2.bs, var2.bt);
      this.bm -= (double)(OMathHelper.b(this.bs / 180.0F * 3.1415927F) * 0.16F);
      this.bn -= 0.10000000149011612D;
      this.bo -= (double)(OMathHelper.a(this.bs / 180.0F * 3.1415927F) * 0.16F);
      this.c(this.bm, this.bn, this.bo);
      this.bF = 0.0F;
      float var3 = 0.4F;
      this.bp = (double)(-OMathHelper.a(this.bs / 180.0F * 3.1415927F) * OMathHelper.b(this.bt / 180.0F * 3.1415927F) * var3);
      this.br = (double)(OMathHelper.b(this.bs / 180.0F * 3.1415927F) * OMathHelper.b(this.bt / 180.0F * 3.1415927F) * var3);
      this.bq = (double)(-OMathHelper.a(this.bt / 180.0F * 3.1415927F) * var3);
   ...
   public void a(double var1, double var3, double var5, float var7, float var8) {
      ...
      var3 /= (double)var9;
      var5 /= (double)var9;
      var1 += this.bS.nextGaussian() * 0.007499999832361937D * (double)var8;
      var3 += this.bS.nextGaussian() * 0.007499999832361937D * (double)var8;
      var5 += this.bS.nextGaussian() * 0.007499999832361937D * (double)var8;
      var1 *= (double)var7;
      var3 *= (double)var7;
      var5 *= (double)var7;
      this.bp = var1;
      ...
      this.bv = this.bt = (float)(Math.atan2(var3, (double)var10) * 180.0D / 3.1415927410125732D);
      this.i = 0;
   }
   ...
   public void F_() {
      super.F_();
      if(this.l > 0) {
         double var1 = this.bm + (this.m - this.bm) / (double)this.l;
         double var3 = this.bn + (this.n - this.bn) / (double)this.l;
         double var5 = this.bo + (this.o - this.bo) / (double)this.l;

         double var7;
         for(var7 = this.p - (double)this.bs; var7 < -180.0D; var7 += 360.0D) {
            ;
         }
         ...
         this.bs = (float)((double)this.bs + var7 / (double)this.l);
         this.bt = (float)((double)this.bt + (this.q - (double)this.bt) / (double)this.l);
         --this.l;
         ...
         if(!this.bi.F) {
            ...
            if(this.c != null) {
               if(!this.c.bE) {
                  this.bm = this.c.bm;
                  this.bn = this.c.bw.b + (double)this.c.bH * 0.8D;
                  this.bo = this.c.bo;
                  return;
               }
         ...
         OEntity var12 = null;
         List var13 = this.bi.b((OEntity)this, this.bw.a(this.bp, this.bq, this.br).b(1.0D, 1.0D, 1.0D));
         double var14 = 0.0D;
         ...
         for(int var16 = 0; var16 < var13.size(); ++var16) {
            ...
            if(var17.o_() && (var17 != this.b || this.j >= 5)) {
               float var18 = 0.3F;
               OAxisAlignedBB var19 = var17.bw.b((double)var18, (double)var18, (double)var18);
         ...
         if(var11 != null) {
            if(var11.g != null) {
               if(var11.g.a(ODamageSource.a((OEntity)this, this.b), 0)) {
                  this.c = var11.g;
               }
            } else {
               this.h = true;
         ...
         if(!this.h) {
            ...
            for(this.bt = (float)(Math.atan2(this.bq, (double)var37) * 180.0D / 3.1415927410125732D); this.bt - this.bv < -180.0F; this.bv -= 360.0F) {
               ;
            }
            ...
            for(int var25 = 0; var25 < var39; ++var25) {
               double var26 = this.bw.b + (this.bw.e - this.bw.b) * (double)(var25 + 0) / (double)var39 - 0.125D + 0.125D;
               double var28 = this.bw.b + (this.bw.e - this.bw.b) * (double)(var25 + 1) / (double)var39 - 0.125D + 0.125D;
            ...
            if(var23 > 0.0D) {
               if(this.k > 0) {
                  ...
                  if(this.bS.nextInt(var40) == 0) {
                     ...
                     float var31 = (float)OMathHelper.b(this.bw.b);

                     float var34;
                     int var32;
                     float var33;
                     for(var32 = 0; (float)var32 < 1.0F + this.bG * 20.0F; ++var32) {
                        var33 = (this.bS.nextFloat() * 2.0F - 1.0F) * this.bG;
                        var34 = (this.bS.nextFloat() * 2.0F - 1.0F) * this.bG;
                        this.bi.a("bubble", this.bm + (double)var33, (double)(var31 + 1.0F), this.bo + (double)var34, this.bp, this.bq - (double)(this.bS.nextFloat() * 0.2F), this.br);
                     }

                     for(var32 = 0; (float)var32 < 1.0F + this.bG * 20.0F; ++var32) {
                        var33 = (this.bS.nextFloat() * 2.0F - 1.0F) * this.bG;
                        var34 = (this.bS.nextFloat() * 2.0F - 1.0F) * this.bG;
                        this.bi.a("splash", this.bm + (double)var33, (double)(var31 + 1.0F), this.bo + (double)var34, this.bp, this.bq, this.br);
                     }
                  }
               }
            }
            ...
            if(this.k > 0) {
               this.bq -= (double)(this.bS.nextFloat() * this.bS.nextFloat() * this.bS.nextFloat()) * 0.2D;
            }
            ...
            this.bp *= (double)var38;
            this.bq *= (double)var38;
            this.br *= (double)var38;
            this.c(this.bm, this.bn, this.bo);
         }
      }
   }
   ...
   public int k() {
      ...
      if(this.c != null) {
         ...
         double var8 = (double)OMathHelper.a(var2 * var2 + var4 * var4 + var6 * var6);
         double var10 = 0.1D;
         this.c.bp += var2 * var10;
         this.c.bq += var4 * var10 + (double)OMathHelper.a(var8) * 0.08D;
         ...
         double var19 = (double)OMathHelper.a(var13 * var13 + var15 * var15 + var17 * var17);
         double var21 = 0.1D;
         var12.bp = var13 * var21;
         var12.bq = var15 * var21 + (double)OMathHelper.a(var19) * 0.08D;
         var12.br = var17 * var21;
         this.bi.b((OEntity)var12);
