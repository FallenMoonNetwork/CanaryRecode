...
public class OBlockStem extends OBlockFlower {
   ...
   public void a(OIBlockAccess var1, int var2, int var3, int var4) {
      this.bZ = (double)((float)(var1.c(var2, var3, var4) * 2 + 2) / 16.0F);
      float var5 = 0.125F;
      ...
      if(!var1.F) {
         ...
         for(int var9 = 0; var9 < 3; ++var9) {
            if(var1.r.nextInt(15) <= var5) {
               ...
               OEntityItem var14 = new OEntityItem(var1, (double)((float)var2 + var11), (double)((float)var3 + var12), (double)((float)var4 + var13), new OItemStack(var8));
               var14.c = 10;
