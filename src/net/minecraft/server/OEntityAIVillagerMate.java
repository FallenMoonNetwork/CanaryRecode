...
public class OEntityAIVillagerMate extends OEntityAIBase {
   ...
   public void e() {
      ...
      if(this.b.j(this.c) > 2.25D) {
         this.b.al().a((OEntityLiving)this.c, 0.25F);
   ...
   private void a(OEntityLiving var1) {
      ...
      for(int var3 = 0; var3 < 5; ++var3) {
         ...
         this.d.a("heart", var1.bm + (double)(var2.nextFloat() * var1.bG * 2.0F) - (double)var1.bG, var1.bn + 1.0D + (double)(var2.nextFloat() * var1.bH), var1.bo + (double)(var2.nextFloat() * var1.bG * 2.0F) - (double)var1.bG, var4, var6, var8);
      }
