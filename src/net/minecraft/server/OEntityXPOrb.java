...
public class OEntityXPOrb extends OEntity {
   ...
   public OEntityXPOrb(OWorld var1, double var2, double var4, double var6, int var8) {
      ...
      this.bp = (double)((float)(Math.random() * 0.20000000298023224D - 0.10000000149011612D) * 2.0F);
      this.bq = (double)((float)(Math.random() * 0.2D) * 2.0F);
      this.br = (double)((float)(Math.random() * 0.20000000298023224D - 0.10000000149011612D) * 2.0F);
      this.e = var8;
   }
   ...
   public void F_() {
      ...
      if(var3 != null) {
         ...
         double var6 = (var3.bn + (double)var3.B() - this.bn) / var1;
      ...
      this.bp *= (double)var14;
      this.bq *= 0.9800000190734863D;
      this.br *= (double)var14;
      if(this.bx) {
