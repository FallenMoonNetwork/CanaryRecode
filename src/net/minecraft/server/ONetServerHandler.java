...
public class ONetServerHandler extends ONetHandler implements OICommandListener {
   ...
   public void a(OPacket15Place var1) {
      ...
      if(var1.d == 255) {
         ...
         if(this.r && this.e.e((double)var5 + 0.5D, (double)var6 + 0.5D, (double)var7 + 0.5D) < 64.0D && (var12 > 16 || var9)) {
   ...
   public void a(OPacket3Chat var1) {
      ...
      if(var2.length() > 100) {
         ...
         if(var2.startsWith("/")) {
            ...
            var2 = "<" + this.e.v + "> " + var2;
            a.info(var2);
            this.d.h.a((OPacket)(new OPacket3Chat(var2)));
         }
   ...
   private void c(String var1) {
      if(var1.toLowerCase().startsWith("/me ")) {
         ...
         a.info(var1);
         this.d.h.a((OPacket)(new OPacket3Chat(var1)));
         ...
         if(var2.length >= 3) {
            ...
            if(!this.d.h.a(var2[1], (OPacket)(new OPacket3Chat(var1)))) {
               this.b((OPacket)(new OPacket3Chat("\u00a7cThere\'s no player by that name online.")));
            }
         }
      } else {
         String var3;
         if(this.d.h.h(this.e.v)) {
            ...
            this.d.a(var3, (OICommandListener)this);
         } else {
            var3 = var1.substring(1);
