...
public class ONetServerHandler extends ONetHandler implements OICommandListener {
    ...
    public void a(OPacket14BlockDig var1) {
        ...
        if (var1.e == 4) {
            ...
            boolean var3 = var2.H = var2.t.g != 0 || this.d.h.h(this.e.v) || getUser().isAdmin(); //CanaryMod allowing admin dig rights
            boolean var4 = false;
            if (var1.e == 0) {
                var4 = true;
            }
    ...
    public void a(OPacket15Place var1) {
        ...
        int var7 = var1.c;
        int var8 = var1.d;
        boolean var9 = var2.H = var2.t.g != 0 || this.d.h.h(this.e.v) || getUser().isAdmin(); //CanaryMod allowing admin build rights
        if (var1.d == 255) {
            if (var3 == null) {
                return;
            }
