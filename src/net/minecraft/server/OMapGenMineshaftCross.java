...
public class OMapGenMineshaftCross extends OStructurePiece {

   private final int a;
   private final boolean b;


   public OMapGenMineshaftCross(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.a = var4;
      this.g = var3;
      this.b = var3.c() > 3;
   ...
   public static OStructureBoundingBox a(List var0, Random var1, int var2, int var3, int var4, int var5) {
      ...
      return OStructurePiece.a(var0, var6) != null?null:var6;
   }
   ...
   public void a(OStructurePiece var1, List var2, Random var3) {
      ...
      switch(this.a) {
      case 0:
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + 1, this.g.b, this.g.f + 1, 0, var4);
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b, this.g.c + 1, 1, var4);
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.d + 1, this.g.b, this.g.c + 1, 3, var4);
         break;
      case 1:
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + 1, this.g.b, this.g.c - 1, 2, var4);
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + 1, this.g.b, this.g.f + 1, 0, var4);
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b, this.g.c + 1, 1, var4);
         break;
      case 2:
      ...
      if(this.b) {
         if(var3.nextBoolean()) {
            OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + 1, this.g.b + 3 + 1, this.g.c - 1, 2, var4);
         }

         if(var3.nextBoolean()) {
            OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b + 3 + 1, this.g.c + 1, 1, var4);
         }

         if(var3.nextBoolean()) {
            OMapGenMineshaftPieces.a(var1, var2, var3, this.g.d + 1, this.g.b + 3 + 1, this.g.c + 1, 3, var4);
         }

         if(var3.nextBoolean()) {
            OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a + 1, this.g.b + 3 + 1, this.g.f + 1, 0, var4);
         }
      }
