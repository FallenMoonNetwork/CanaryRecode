...
public class OEntityIronGolem extends OEntityGolem {
   ...
   public void e() {
      ...
      if(this.bp * this.bp + this.br * this.br > 2.500000277905201E-7D && this.bS.nextInt(5) == 0) {
         ...
         if(var4 > 0) {
            this.bi.a("tilecrack_" + var4, this.bm + ((double)this.bS.nextFloat() - 0.5D) * (double)this.bG, this.bw.b + 0.1D, this.bo + ((double)this.bS.nextFloat() - 0.5D) * (double)this.bG, 4.0D * ((double)this.bS.nextFloat() - 0.5D), 0.5D, ((double)this.bS.nextFloat() - 0.5D) * 4.0D);
         }
      }
   ...
   public boolean a(OEntity var1) {
      ...
      boolean var2 = var1.a(ODamageSource.a((OEntityLiving)this), 7 + this.bS.nextInt(15));
      if(var2) {
