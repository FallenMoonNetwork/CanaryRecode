...
public class OEntityAIHurtByTarget extends OEntityAITarget {
   ...
   public void c() {
      this.c.b(this.c.ao());
      if(this.a) {
         List var1 = this.c.bi.a(this.c.getClass(), OAxisAlignedBB.b(this.c.bm, this.c.bn, this.c.bo, this.c.bm + 1.0D, this.c.bn + 1.0D, this.c.bo + 1.0D).b((double)this.d, 4.0D, (double)this.d));
