...
public class OEntityArrow extends OEntity {
   ...
   public OEntityArrow(OWorld var1, OEntityLiving var2, OEntityLiving var3, float var4, float var5) {
      ...
      this.bn = var2.bn + (double)var2.B() - 0.10000000149011612D;
      double var6 = var3.bm - var2.bm;
      double var8 = var3.bn + (double)var3.B() - 0.699999988079071D - this.bn;
   ...
   public OEntityArrow(OWorld var1, OEntityLiving var2, float var3) {
      ...
      this.a = var2 instanceof OEntityPlayer;
      this.b(0.5F, 0.5F);
      this.c(var2.bm, var2.bn + (double)var2.B(), var2.bo, var2.bs, var2.bt);
      ...
      this.bF = 0.0F;
      this.bp = (double)(-OMathHelper.a(this.bs / 180.0F * 3.1415927F) * OMathHelper.b(this.bt / 180.0F * 3.1415927F));
      this.br = (double)(OMathHelper.b(this.bs / 180.0F * 3.1415927F) * OMathHelper.b(this.bt / 180.0F * 3.1415927F));
      this.bq = (double)(-OMathHelper.a(this.bt / 180.0F * 3.1415927F));
   ...
   public void F_() {
      ...
      if(this.bv == 0.0F && this.bu == 0.0F) {
         ...
         this.bv = this.bt = (float)(Math.atan2(this.bq, (double)var1) * 180.0D / 3.1415927410125732D);
      }
      ...
      if(this.j) {
         ...
         if(var3 != null) {
            if(var3.g != null) {
               ...
               int var20 = (int)Math.ceil((double)var19 * this.m);
               if(this.d) {
               ...
               if(var3.g.a(var22, var20)) {
                  if(var3.g instanceof OEntityLiving) {
                     ...
                     if(this.n > 0) {
                        ...
                        if(var21 > 0.0F) {
                           var3.g.b_(this.bp * (double)this.n * 0.6000000238418579D / (double)var21, 0.1D, this.br * (double)this.n * 0.6000000238418579D / (double)var21);
                        }
                     }
                  }
               ...
               this.bp = (double)((float)(var3.f.a - this.bm));
               this.bq = (double)((float)(var3.f.b - this.bn));
               this.br = (double)((float)(var3.f.c - this.bo));
               var19 = OMathHelper.a(this.bp * this.bp + this.bq * this.bq + this.br * this.br);
               this.bm -= this.bp / (double)var19 * 0.05000000074505806D;
               this.bn -= this.bq / (double)var19 * 0.05000000074505806D;
               this.bo -= this.br / (double)var19 * 0.05000000074505806D;
               this.bi.a(this, "random.bowhit", 1.0F, 1.2F / (this.bS.nextFloat() * 0.2F + 0.9F));
               this.j = true;
               this.b = 7;
               this.d = false;
         ...
         if(this.d) {
            for(var8 = 0; var8 < 4; ++var8) {
               this.bi.a("crit", this.bm + this.bp * (double)var8 / 4.0D, this.bn + this.bq * (double)var8 / 4.0D, this.bo + this.br * (double)var8 / 4.0D, -this.bp, -this.bq + 0.2D, -this.br);
            }
         }
         ...
         for(this.bt = (float)(Math.atan2(this.bq, (double)var19) * 180.0D / 3.1415927410125732D); this.bt - this.bv < -180.0F; this.bv -= 360.0F) {
            ;
         }
         ...
         if(this.aU()) {
            for(int var25 = 0; var25 < 4; ++var25) {
               float var24 = 0.25F;
               this.bi.a("bubble", this.bm - this.bp * (double)var24, this.bn - this.bq * (double)var24, this.bo - this.br * (double)var24, this.bp, this.bq, this.br);
            }

            var23 = 0.8F;
         }

         this.bp *= (double)var23;
         this.bq *= (double)var23;
         this.br *= (double)var23;
         this.bq -= (double)var10;
         this.c(this.bm, this.bn, this.bo);
      }
   }
