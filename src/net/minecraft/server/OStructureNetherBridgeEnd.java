...
public class OStructureNetherBridgeEnd extends OComponentNetherBridgePiece {

   private int a;


   public OStructureNetherBridgeEnd(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
      this.a = var2.nextInt();
   ...
   public static OStructureNetherBridgeEnd a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, -1, -3, 0, 5, 10, 8, var5);
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OStructureNetherBridgeEnd(var6, var1, var7, var5):null;
   }
