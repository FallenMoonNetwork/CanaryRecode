...
abstract class OComponentVillage extends OStructureComponent {
    ...
    protected OComponentVillage(int var1) {
        super(var1);
    }

    protected OStructureComponent a(OComponentVillageStartPiece var1, List var2, Random var3, int var4, int var5) {
        switch (this.h) {
        case 0:
    ...
    protected OStructureComponent b(OComponentVillageStartPiece var1, List var2, Random var3, int var4, int var5) {
        switch (this.h) {
        case 0:
