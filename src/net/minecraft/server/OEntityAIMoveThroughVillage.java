      ...
      if(this.e && this.a.bi.e()) {
         ...
         if(var1 == null) {
            ...
            if(this.d == null) {
               ...
               this.a.al().b(false);
               this.c = this.a.al().a((double)this.d.a, (double)this.d.b, (double)this.d.c);
               this.a.al().b(var2);
               if(this.c != null) {
                  return true;
               } else {
                  OVec3D var3 = ORandomPositionGenerator.a(this.a, 10, 7, OVec3D.b((double)this.d.a, (double)this.d.b, (double)this.d.c));
                  if(var3 == null) {
                     return false;
                  } else {
                     this.a.al().b(false);
