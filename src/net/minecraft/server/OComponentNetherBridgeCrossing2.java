...
public class OComponentNetherBridgeCrossing2 extends OComponentNetherBridgePiece {
   ...
   public OComponentNetherBridgeCrossing2(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
   ...
   public static OComponentNetherBridgeCrossing2 a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OComponentNetherBridgeCrossing2(var6, var1, var7, var5):null;
   }
   ...
   public boolean a(OWorld var1, Random var2, OStructureBoundingBox var3) {
      ...
      this.a(var1, var3, 0, 2, 4, 0, 5, 4, OBlock.bA.bO, OBlock.bA.bO, false);
      this.a(var1, var3, 4, 2, 4, 4, 5, 4, OBlock.bA.bO, OBlock.bA.bO, false);
