...
public class OPathNavigate {
   ...
   public boolean a(double var1, double var3, double var5, float var7) {
      OPathEntity var8 = this.a((double)OMathHelper.b(var1), (double)((int)var3), (double)OMathHelper.b(var5));
   ...
   public void d() {
      ...
      if(!this.e()) {
         ...
         if(!this.e()) {
            OVec3D var1 = this.c.a((OEntity)this.a);
            if(var1 != null) {
   ...
   private void g() {
      ...
      for(var4 = this.c.e(); var4 < var2; ++var4) {
         if(var1.c(this.c.a(this.a, var4)) < (double)var8) {
            this.c.c(var4 + 1);
         }
      }

      var4 = (int)Math.ceil((double)this.a.bG);
   ...
   private OVec3D h() {
      return OVec3D.b(this.a.bm, (double)this.i(), this.a.bo);
   }
