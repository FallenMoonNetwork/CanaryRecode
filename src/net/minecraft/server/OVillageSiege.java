   ...
   private boolean b() {
      ...
      while(var2.hasNext()) {
         ...
         if(this.f != null && this.f.c() >= 10 && this.f.d() >= 20 && this.f.e() >= 20) {
            ...
            while(true) {
               if(var7 < 10) {
                  this.g = var4.a + (int)((double)(OMathHelper.b(this.a.r.nextFloat() * 3.1415927F * 2.0F) * var5) * 0.9D);
                  this.h = var4.b;
                  this.i = var4.c + (int)((double)(OMathHelper.a(this.a.r.nextFloat() * 3.1415927F * 2.0F) * var5) * 0.9D);
                  var6 = false;
   ...
   private OVec3D a(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < 10; ++var4) {
         ...
         if(this.f.a(var5, var6, var7) && OSpawnerAnimals.a(OEnumCreatureType.a, this.a, var5, var6, var7)) {
            return OVec3D.b((double)var5, (double)var6, (double)var7);
         }
      }
