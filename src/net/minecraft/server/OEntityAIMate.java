...
public class OEntityAIMate extends OEntityAIBase {
   ...
   public void e() {
      this.d.ai().a(this.e, 10.0F, (float)this.d.D());
      this.d.al().a((OEntityLiving)this.e, this.c);
      ++this.b;
      if(this.b == 60) {
         this.i();
      }
   ...
   private OEntityAnimal f() {
      float var1 = 8.0F;
      List var2 = this.a.a(this.d.getClass(), this.d.bw.b((double)var1, (double)var1, (double)var1));
   ...
   private void i() {
      ...
      if(var1 != null) {
         ...
         for(int var3 = 0; var3 < 7; ++var3) {
            ...
            this.a.a("heart", this.d.bm + (double)(var2.nextFloat() * this.d.bG * 2.0F) - (double)this.d.bG, this.d.bn + 0.5D + (double)(var2.nextFloat() * this.d.bH), this.d.bo + (double)(var2.nextFloat() * this.d.bG * 2.0F) - (double)this.d.bG, var4, var6, var8);
         }
