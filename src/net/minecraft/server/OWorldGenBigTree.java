...
public class OWorldGenBigTree extends OWorldGenerator {
      ...
      while(var6 >= 0) {
         ...
         if(var8 < 0.0F) {
            ...
            for(double var9 = 0.5D; var7 < var1; ++var7) {
               ...
               int var15 = OMathHelper.b(var11 * Math.sin(var13) + (double)this.d[0] + var9);
               int var16 = OMathHelper.b(var11 * Math.cos(var13) + (double)this.d[2] + var9);
   ...
   float a(int var1) {
      if((double)var1 < (double)((float)this.e) * 0.3D) {
         ...
         float var3 = (float)this.e / 2.0F - (float)var1;
         float var4;
         if(var3 == 0.0F) {
            var4 = var2;
   ...
   void a(int[] var1, int[] var2, int var3) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            var14[var6] = OMathHelper.b((double)(var1[var6] + var15) + 0.5D);
            var14[var7] = OMathHelper.b((double)var1[var7] + (double)var15 * var10 + 0.5D);
            var14[var8] = OMathHelper.b((double)var1[var8] + (double)var15 * var12 + 0.5D);
   ...
   boolean c(int var1) {
      return (double)var1 >= (double)this.e * 0.2D;
   }
   ...
   int a(int[] var1, int[] var2) {
      ...
      if(var3[var5] == 0) {
         ...
         for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
            ...
            var13[var6] = OMathHelper.b((double)var1[var6] + (double)var14 * var9);
            var13[var7] = OMathHelper.b((double)var1[var7] + (double)var14 * var11);
