...
public class OMapGenVillageTorch extends OMapGenVillageStructureGen {

   private int a = -1;


   public OMapGenVillageTorch(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
