...
public class OEntityAIFleeSun extends OEntityAIBase {
   ...
   private OVec3D f() {
      ...
      for(int var2 = 0; var2 < 10; ++var2) {
         int var3 = OMathHelper.b(this.a.bm + (double)var1.nextInt(20) - 10.0D);
         int var4 = OMathHelper.b(this.a.bw.b + (double)var1.nextInt(6) - 3.0D);
         int var5 = OMathHelper.b(this.a.bo + (double)var1.nextInt(20) - 10.0D);
         if(!this.f.l(var3, var4, var5) && this.a.a(var3, var4, var5) < 0.0F) {
            return OVec3D.b((double)var3, (double)var4, (double)var5);
         }
      }
