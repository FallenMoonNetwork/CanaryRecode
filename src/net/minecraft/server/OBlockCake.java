...
public class OBlockCake extends OBlock {
   ...
   public OAxisAlignedBB e(OWorld var1, int var2, int var3, int var4) {
      ...
      float var7 = (float)(1 + var5 * 2) / 16.0F;
      float var8 = 0.5F;
      return OAxisAlignedBB.b((double)((float)var2 + var7), (double)var3, (double)((float)var4 + var6), (double)((float)(var2 + 1) - var6), (double)((float)var3 + var8 - var6), (double)((float)(var4 + 1) - var6));
   }
