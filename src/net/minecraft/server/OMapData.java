   ...
   public void a(OEntityPlayer var1, OItemStack var2) {
      ...
      for(int var14 = 0; var14 < this.h.size(); ++var14) {
         ...
         if(!var4.a.bE && var4.a.k.c(var2)) {
            float var5 = (float)(var4.a.bm - (double)this.b) / (float)(1 << this.e);
            float var6 = (float)(var4.a.bo - (double)this.c) / (float)(1 << this.e);
            byte var7 = 64;
            byte var8 = 64;
            if(var5 >= (float)(-var7) && var6 >= (float)(-var8) && var5 <= (float)var7 && var6 <= (float)var8) {
               ...
               byte var12 = (byte)((int)((double)(var1.bs * 16.0F / 360.0F) + 0.5D));
               if(this.d < 0) {
                  int var13 = this.g / 10;
