...
public class OEntityEnderEye extends OEntity {
   ...
   public void a(double var1, int var3, double var4) {
      ...
      if(var10 > 12.0F) {
         this.b = this.bm + var6 / (double)var10 * 12.0D;
         this.d = this.bo + var8 / (double)var10 * 12.0D;
         this.c = this.bn + 8.0D;
      } else {
         this.b = var1;
         this.c = (double)var3;
   ...
   public void F_() {
      ...
      for(this.bt = (float)(Math.atan2(this.bq, (double)var1) * 180.0D / 3.1415927410125732D); this.bt - this.bv < -180.0F; this.bv -= 360.0F) {
         ;
      }
      ...
      if(!this.bi.F) {
         ...
         this.bp = Math.cos((double)var7) * var8;
         this.br = Math.sin((double)var7) * var8;
         if(this.bn < this.c) {
      ...
      if(this.aU()) {
         for(int var11 = 0; var11 < 4; ++var11) {
            this.bi.a("bubble", this.bm - this.bp * (double)var10, this.bn - this.bq * (double)var10, this.bo - this.br * (double)var10, this.bp, this.bq, this.br);
         }
      } else {
         this.bi.a("portal", this.bm - this.bp * (double)var10 + this.bS.nextDouble() * 0.6D - 0.3D, this.bn - this.bq * (double)var10 - 0.5D, this.bo - this.br * (double)var10 + this.bS.nextDouble() * 0.6D - 0.3D, this.bp, this.bq, this.br);
      }
      ...
      if(!this.bi.F) {
         ...
         if(this.e > 80 && !this.bi.F) {
            this.X();
            if(this.f) {
               this.bi.b((OEntity)(new OEntityItem(this.bi, this.bm, this.bn, this.bo, new OItemStack(OItem.bz))));
            } else {
