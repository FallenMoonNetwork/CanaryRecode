...
public abstract class OEntityThrowable extends OEntity {
   ...
   public OEntityThrowable(OWorld var1, OEntityLiving var2) {
      ...
      this.bq = (double)(-OMathHelper.a((this.bt + this.d()) / 180.0F * 3.1415927F) * var3);
   ...
   public void F_() {
      ...
      for(this.bt = (float)(Math.atan2(this.bq, (double)var18) * 180.0D / 3.1415927410125732D); this.bt - this.bv < -180.0F; this.bv -= 360.0F) {
         ;
      }
      ...
      if(this.aU()) {
         for(int var16 = 0; var16 < 4; ++var16) {
            float var20 = 0.25F;
            this.bi.a("bubble", this.bm - this.bp * (double)var20, this.bn - this.bq * (double)var20, this.bo - this.br * (double)var20, this.bp, this.bq, this.br);
         }

         var19 = 0.8F;
      }

      this.bp *= (double)var19;
      this.bq *= (double)var19;
      this.br *= (double)var19;
      this.bq -= (double)var15;
      this.c(this.bm, this.bn, this.bo);
   }
