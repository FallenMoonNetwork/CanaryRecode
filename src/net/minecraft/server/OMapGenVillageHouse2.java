...
public class OMapGenVillageHouse2 extends OMapGenVillageStructureGen {
   ...
   public OMapGenVillageHouse2(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
   ...
   public static OMapGenVillageHouse2 a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, 0, 0, 0, 10, 6, 7, var5);
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OMapGenVillageHouse2(var6, var1, var7, var5):null;
   }
