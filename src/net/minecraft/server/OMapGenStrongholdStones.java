...
class OMapGenStrongholdStones extends OStructurePieceBlockSelector {

   private OMapGenStrongholdStones() {
      super();
   }
   ...
   // $FF: synthetic method
   OMapGenStrongholdStones(OMapGenStrongholdPieceWeight2 var1) {
      this();
   }
}
