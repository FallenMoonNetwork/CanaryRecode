...
import net.minecraft.server.OBlockEnderPortal;
...
public class OEntityDragon extends OEntityDragonBase {
   ...
   public void e() {
      ...
      if(this.ap <= 0) {
         ...
         this.bi.a("largeexplode", this.bm + (double)var1, this.bn + 2.0D + (double)var45, this.bo + (double)var3, 0.0D, 0.0D, 0.0D);
      } else {
         this.A();
         ...
         this.d[this.e][0] = (double)this.bs;
         ...
         if(this.bi.F) {
            if(this.aN > 0) {
               var4 = this.bm + (this.aO - this.bm) / (double)this.aN;
               var6 = this.bn + (this.aP - this.bn) / (double)this.aN;
               var8 = this.bo + (this.aQ - this.bo) / (double)this.aN;

               for(var10 = this.aR - (double)this.bs; var10 < -180.0D; var10 += 360.0D) {
                  ;
               }
               ...
               this.bs = (float)((double)this.bs + var10 / (double)this.aN);
            ...
            var6 /= (double)OMathHelper.a(var4 * var4 + var8 * var8);
            var20 = 0.6F;
            ...
            double var23;
            for(var23 = var21 - (double)this.bs; var23 < -180.0D; var23 += 360.0D) {
               ;
            }
            ...
            OVec3D var26 = OVec3D.b((double)OMathHelper.a(this.bs * 3.1415927F / 180.0F), this.bq, (double)(-OMathHelper.b(this.bs * 3.1415927F / 180.0F))).b();
            ...
            this.aY = (float)((double)this.aY + var23 * (0.699999988079071D / var29 / (double)var28));
            ...
            this.bp *= (double)var34;
            this.br *= (double)var34;
         ...
         this.h.F_();
         this.h.c(this.bm + (double)(var37 * 0.5F), this.bn, this.bo - (double)(var38 * 0.5F), 0.0F, 0.0F);
         this.l.F_();
         this.l.c(this.bm + (double)(var38 * 4.5F), this.bn + 2.0D, this.bo + (double)(var37 * 4.5F), 0.0F, 0.0F);
         this.m.F_();
         this.m.c(this.bm - (double)(var38 * 4.5F), this.bn + 2.0D, this.bo - (double)(var37 * 4.5F), 0.0F, 0.0F);
         if(!this.bi.F) {
            this.C();
         }

         if(!this.bi.F && this.at == 0) {
            this.a(this.bi.b((OEntity)this, this.l.bw.b(4.0D, 2.0D, 4.0D).d(0.0D, -2.0D, 0.0D)));
            this.a(this.bi.b((OEntity)this, this.m.bw.b(4.0D, 2.0D, 4.0D).d(0.0D, -2.0D, 0.0D)));
            this.b(this.bi.b((OEntity)this, this.g.bw.b(1.0D, 1.0D, 1.0D)));
         }
         ...
         this.g.F_();
         this.g.c(this.bm + (double)(var20 * 5.5F * var3), this.bn + (var40[1] - var39[1]) * 1.0D + (double)(var35 * 5.5F), this.bo - (double)(var41 * 5.5F * var3), 0.0F, 0.0F);
         ...
         for(int var50 = 0; var50 < 3; ++var50) {
            ...
            var46.F_();
            var46.c(this.bm - (double)((var37 * var47 + var43 * var48) * var3), this.bn + (var49[1] - var39[1]) * 1.0D - (double)((var48 + var47) * var35) + 1.5D, this.bo + (double)((var38 * var47 + var44 * var48) * var3), 0.0F, 0.0F);
         }
   ...
   private void A() {
      ...
      if(this.bS.nextInt(10) == 0) {
         float var1 = 32.0F;
         List var2 = this.bi.a(OEntityEnderCrystal.class, this.bw.b((double)var1, (double)var1, (double)var1));
   ...
   private void b(List var1) {
      for(int var2 = 0; var2 < var1.size(); ++var2) {
         ...
         if(var3 instanceof OEntityLiving) {
            var3.a(ODamageSource.a((OEntityLiving)this), 10);
         }
      }
   ...
   private void E() {
      ...
      if(this.bS.nextInt(2) == 0 && this.bi.d.size() > 0) {
         ...
         do {
            this.a = 0.0D;
            this.b = (double)(70.0F + this.bS.nextFloat() * 50.0F);
            this.c = 0.0D;
            this.a += (double)(this.bS.nextFloat() * 120.0F - 60.0F);
            this.c += (double)(this.bS.nextFloat() * 120.0F - 60.0F);
   ...
   private boolean a(OAxisAlignedBB var1) {
      ...
      if(var9) {
         double var14 = var1.a + (var1.d - var1.a) * (double)this.bS.nextFloat();
         double var16 = var1.b + (var1.e - var1.b) * (double)this.bS.nextFloat();
         double var18 = var1.c + (var1.f - var1.c) * (double)this.bS.nextFloat();
   ...
   public boolean a(OEntityDragonPart var1, ODamageSource var2, int var3) {
      ...
      this.a = this.bm + (double)(var5 * 5.0F) + (double)((this.bS.nextFloat() - 0.5F) * 2.0F);
      this.b = this.bn + (double)(this.bS.nextFloat() * 3.0F) + 1.0D;
      this.c = this.bo - (double)(var6 * 5.0F) + (double)((this.bS.nextFloat() - 0.5F) * 2.0F);
      this.u = null;
   ...
   protected void aB() {
      ...
      if(this.r >= 180 && this.r <= 200) {
         ...
         this.bi.a("hugeexplosion", this.bm + (double)var1, this.bn + 2.0D + (double)var2, this.bo + (double)var3, 0.0D, 0.0D, 0.0D);
      }
      ...
      if(!this.bi.F && this.r > 150 && this.r % 5 == 0) {
         ...
         while(var4 > 0) {
            ...
            var4 -= var5;
            this.bi.b((OEntity)(new OEntityXPOrb(this.bi, this.bm, this.bn, this.bo, var5)));
         }
      }
      ...
      for(int var5 = var3 - 1; var5 <= var3 + 32; ++var5) {
         for(int var6 = var1 - var4; var6 <= var1 + var4; ++var6) {
            for(int var7 = var2 - var4; var7 <= var2 + var4; ++var7) {
               ...
               double var12 = (double)OMathHelper.a(var8 * var8 + var10 * var10);
