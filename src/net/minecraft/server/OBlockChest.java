...
public class OBlockChest extends OBlockContainer {
   ...
   public void a(OWorld var1, int var2, int var3, int var4, OEntityLiving var5) {
      ...
      byte var10 = 0;
      int var11 = OMathHelper.b((double)(var5.bs * 4.0F / 360.0F) + 0.5D) & 3;
      if(var11 == 0) {
         var10 = 2;
      }
      ...
      if(var5 != null) {
         for(int var6 = 0; var6 < var5.c(); ++var6) {
            ...
            if(var7 != null) {
               ...
               OEntityItem var12;
               for(float var10 = this.a.nextFloat() * 0.8F + 0.1F; var7.a > 0; var1.b((OEntity)var12)) {
                  ...
                  var7.a -= var11;
                  var12 = new OEntityItem(var1, (double)((float)var2 + var8), (double)((float)var3 + var9), (double)((float)var4 + var10), new OItemStack(var7.c, var11, var7.h()));
                  float var13 = 0.05F;
   ...
   public boolean a(OWorld var1, int var2, int var3, int var4, OEntityPlayer var5) {
      Object var6 = (OTileEntityChest)var1.b(var2, var3, var4);
      if(var6 == null) {
         return true;
   ...
   private static boolean h(OWorld var0, int var1, int var2, int var3) {
      Iterator var4 = var0.a(OEntityOcelot.class, OAxisAlignedBB.b((double)var1, (double)(var2 + 1), (double)var3, (double)(var1 + 1), (double)(var2 + 2), (double)(var3 + 1))).iterator();
