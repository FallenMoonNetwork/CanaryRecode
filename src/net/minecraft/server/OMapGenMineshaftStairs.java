...
public class OMapGenMineshaftStairs extends OStructurePiece {

   public OMapGenMineshaftStairs(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
   ...
   public void a(OStructurePiece var1, List var2, Random var3) {
      ...
      switch(this.h) {
      case 0:
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a, this.g.b, this.g.f + 1, 0, var4);
         break;
      case 1:
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b, this.g.c, 1, var4);
         break;
      case 2:
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.a, this.g.b, this.g.c - 1, 2, var4);
         break;
      case 3:
         OMapGenMineshaftPieces.a(var1, var2, var3, this.g.d + 1, this.g.b, this.g.c, 3, var4);
      }
