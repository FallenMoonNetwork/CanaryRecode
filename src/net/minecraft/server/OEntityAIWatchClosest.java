...
public class OEntityAIWatchClosest extends OEntityAIBase {
   ...
   public boolean a() {
      if(this.a.an().nextFloat() >= this.e) {
         ...
         if(this.f == OEntityPlayer.class) {
            this.b = this.a.bi.a(this.a, (double)this.c);
         } else {
            this.b = this.a.bi.a(this.f, this.a.bw.b((double)this.c, 3.0D, (double)this.c), this.a);
         }
   ...
   public boolean b() {
      return !this.b.aE()?false:(this.a.j(this.b) > (double)(this.c * this.c)?false:this.d > 0);
   }
   ...
   public void e() {
      this.a.ai().a(this.b.bm, this.b.bn + (double)this.b.B(), this.b.bo, 10.0F, (float)this.a.D());
      --this.d;
   }
}
