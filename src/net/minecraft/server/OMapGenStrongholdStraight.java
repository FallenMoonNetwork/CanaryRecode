...
public class OMapGenStrongholdStraight extends OMapGenStrongholdPiece {
   ...
   public OMapGenStrongholdStraight(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.a = this.a(var2);
      this.g = var3;
   ...
   public void a(OStructurePiece var1, List var2, Random var3) {
      ...
      if(this.b) {
         this.b((OMapGenStrongholdStairs2)var1, var2, var3, 1, 2);
      }

      if(this.c) {
         this.c((OMapGenStrongholdStairs2)var1, var2, var3, 1, 2);
      }

   }

   public static OMapGenStrongholdStraight a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, -1, -1, 0, 5, 5, 7, var5);
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OMapGenStrongholdStraight(var6, var1, var7, var5):null;
   }
   ...
   public boolean a(OWorld var1, Random var2, OStructureBoundingBox var3) {
      if(this.a(var1, var3)) {
         ...
         this.a(var1, var3, 0, 0, 0, 4, 4, 6, true, var2, OMapGenStrongholdPieces.b());
