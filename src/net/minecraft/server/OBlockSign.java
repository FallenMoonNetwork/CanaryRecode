...
public class OBlockSign implements OIChunkLoader, OIThreadedFileIO {
   ...
   private void a(OAnvilChunkLoaderPending var1) {
   ...
   private void a(OChunk var1, OWorld var2, ONBTTagCompound var3) {
      ...
      if(var20 != null) {
         ...
         while(var14.hasNext()) {
            ...
            var16.a("net/minecraft/server/OBiomeGenTaiga", var15.d);
            var16.a("net/minecraft/server/OBiomeGenHell", var15.a);
            var16.a("net/minecraft/server/OMapGenStrongholdStairs2", var15.b);
            var16.a("net/minecraft/server/OSlotEnchantmentTable", var15.c);
            var16.a("net/minecraft/server/OPacket5PlayerInventory", (int)(var15.e - var11));
      ...
      if(var2.c("TileTicks")) {
         ...
         if(var19 != null) {
            for(int var22 = 0; var22 < var19.d(); ++var22) {
               ...
               var1.d(var23.f("net/minecraft/server/OBiomeGenHell"), var23.f("net/minecraft/server/OMapGenStrongholdStairs2"), var23.f("net/minecraft/server/OSlotEnchantmentTable"), var23.f("net/minecraft/server/OBiomeGenTaiga"), var23.f("net/minecraft/server/OPacket5PlayerInventory"));
            }
         }
      }
