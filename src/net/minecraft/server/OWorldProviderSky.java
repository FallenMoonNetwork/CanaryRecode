...
import net.minecraft.server.OChunkProviderSky;
...
public class OWorldProviderSky extends OWorldProvider {

   public OWorldProviderSky() {
      super();
   }
   ...
   public OIChunkProvider b() {
      return new OChunkProviderSky(this.a, this.a.n());
   }
