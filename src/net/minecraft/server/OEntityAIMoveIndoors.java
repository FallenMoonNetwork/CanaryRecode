...
public class OEntityAIMoveIndoors extends OEntityAIBase {
   ...
   public boolean a() {
      if((!this.a.bi.e() || this.a.bi.x()) && !this.a.bi.t.e) {
         if(this.a.an().nextInt(50) != 0) {
            return false;
         } else if(this.c != -1 && this.a.e((double)this.c, this.a.bn, (double)this.d) < 4.0D) {
            return false;
         } else {
   ...
   public void c() {
      ...
      if(this.a.e((double)this.b.a(), (double)this.b.b, (double)this.b.c()) > 256.0D) {
         OVec3D var1 = ORandomPositionGenerator.a(this.a, 14, 3, OVec3D.b((double)this.b.a() + 0.5D, (double)this.b.b(), (double)this.b.c() + 0.5D));
         if(var1 != null) {
            this.a.al().a(var1.a, var1.b, var1.c, 0.3F);
         }
      } else {
         this.a.al().a((double)this.b.a() + 0.5D, (double)this.b.b(), (double)this.b.c() + 0.5D, 0.3F);
      }
