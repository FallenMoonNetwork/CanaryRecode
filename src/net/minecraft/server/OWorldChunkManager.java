...
public class OWorldChunkManager {
   ...
   public OWorldChunkManager(long var1, OEnumWorldType var3) {
      this();
   ...
   public float[] b(float[] var1, int var2, int var3, int var4, int var5) {
      ...
      for(int var7 = 0; var7 < var4 * var5; ++var7) {
         float var8 = (float)OBiomeGenBase.a[var6[var7]].g() / 65536.0F;
         if(var8 > 1.0F) {
            var8 = 1.0F;
         }
   ...
   public float[] a(float[] var1, int var2, int var3, int var4, int var5) {
      ...
      for(int var7 = 0; var7 < var4 * var5; ++var7) {
         float var8 = (float)OBiomeGenBase.a[var6[var7]].h() / 65536.0F;
         if(var8 > 1.0F) {
            var8 = 1.0F;
         }
