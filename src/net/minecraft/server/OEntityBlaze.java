...
public class OEntityBlaze extends OEntityMob {
   ...
   public void e() {
      if(!this.bi.F) {
         ...
         if(this.I() != null && this.I().bn + (double)this.I().B() > this.bn + (double)this.B() + (double)this.a) {
      ...
      for(int var1 = 0; var1 < 2; ++var1) {
         this.bi.a("largesmoke", this.bm + (this.bS.nextDouble() - 0.5D) * (double)this.bG, this.bn + this.bS.nextDouble() * (double)this.bH, this.bo + (this.bS.nextDouble() - 0.5D) * (double)this.bG, 0.0D, 0.0D, 0.0D);
      }
   ...
   protected void a(OEntity var1, float var2) {
      if(this.aw <= 0 && var2 < 2.0F && var1.bw.e > this.bw.b && var1.bw.b < this.bw.e) {
         ...
         double var5 = var1.bw.b + (double)(var1.bH / 2.0F) - (this.bn + (double)(this.bH / 2.0F));
         ...
         if(this.aw == 0) {
            ...
            if(this.g > 1) {
               ...
               for(int var10 = 0; var10 < 1; ++var10) {
                  OEntitySmallFireball var11 = new OEntitySmallFireball(this.bi, this, var3 + this.bS.nextGaussian() * (double)var9, var5, var7 + this.bS.nextGaussian() * (double)var9);
                  var11.bn = this.bn + (double)(this.bH / 2.0F) + 0.5D;
                  this.bi.b((OEntity)var11);
               }
            }
         }
