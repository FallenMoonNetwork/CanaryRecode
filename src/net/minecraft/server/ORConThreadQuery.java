...
public class ORConThreadQuery extends ORConThreadBase {
   ...
   public ORConThreadQuery(OIServer var1) {
      ...
      if(0 == this.h) {
         ...
         var1.a("query.port", (Object)Integer.valueOf(this.h));
   ...
   private boolean a(DatagramPacket var1) {
   ...
   private byte[] b(DatagramPacket var1) {
   ...
   private void d(DatagramPacket var1) {
