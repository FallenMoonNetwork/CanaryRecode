...
public class OComponentStrongholdPortalRoom extends OMapGenStrongholdPiece {
   ...
   public void a(OStructurePiece var1, List var2, Random var3) {
      if(var1 != null) {
         ((OMapGenStrongholdStairs2)var1).b = this;
      }
   ...
   public static OComponentStrongholdPortalRoom a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OComponentStrongholdPortalRoom(var6, var1, var7, var5):null;
   }

   public boolean a(OWorld var1, Random var2, OStructureBoundingBox var3) {
      this.a(var1, var3, 0, 0, 0, 10, 7, 15, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var2, var3, OEnumDoor.c, 4, 1, 0);
      byte var4 = 6;
      this.a(var1, var3, 1, var4, 1, 1, var4, 14, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 9, var4, 1, 9, var4, 14, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 2, var4, 1, 8, var4, 2, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 2, var4, 14, 8, var4, 14, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 1, 1, 1, 2, 1, 4, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 8, 1, 1, 9, 1, 4, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 1, 1, 1, 1, 1, 3, OBlock.C.bO, OBlock.C.bO, false);
      this.a(var1, var3, 9, 1, 1, 9, 1, 3, OBlock.C.bO, OBlock.C.bO, false);
      this.a(var1, var3, 3, 1, 8, 7, 1, 12, false, var2, OMapGenStrongholdPieces.b());
      ...
      this.a(var1, var3, 4, 1, 5, 6, 1, 7, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 4, 2, 6, 6, 2, 7, false, var2, OMapGenStrongholdPieces.b());
      this.a(var1, var3, 4, 3, 7, 6, 3, 7, false, var2, OMapGenStrongholdPieces.b());
