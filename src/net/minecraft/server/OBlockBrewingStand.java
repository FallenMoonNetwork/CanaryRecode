         ...
         for(int var7 = 0; var7 < var6.c(); ++var7) {
            ...
            if(var8 != null) {
               ...
               while(var8.a > 0) {
                  ...
                  var8.a -= var12;
                  OEntityItem var13 = new OEntityItem(var1, (double)((float)var2 + var9), (double)((float)var3 + var10), (double)((float)var4 + var11), new OItemStack(var8.c, var12, var8.h()));
                  float var14 = 0.05F;
                  var13.bp = (double)((float)this.a.nextGaussian() * var14);
                  var13.bq = (double)((float)this.a.nextGaussian() * var14 + 0.2F);
                  var13.br = (double)((float)this.a.nextGaussian() * var14);
