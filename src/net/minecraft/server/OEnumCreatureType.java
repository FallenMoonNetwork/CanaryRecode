...
public enum OEnumCreatureType {
   ...
   a("monster", 0, OIMob.class, 70, OMaterial.a, false),
   b("creature", 1, OEntityAnimal.class, 15, OMaterial.a, true),
   c("waterCreature", 2, OEntityWaterMob.class, 5, OMaterial.g, true);
