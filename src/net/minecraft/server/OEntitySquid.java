...
public class OEntitySquid extends OEntityWaterMob {
   ...
   public void e() {
      ...
      if(this.aU()) {
         ...
         if(!this.bi.F) {
            this.bp = (double)(this.o * this.l);
            this.bq = (double)(this.p * this.l);
            this.br = (double)(this.q * this.l);
         }
         ...
         this.a += (-((float)Math.atan2((double)var1, this.bq)) * 180.0F / 3.1415927F - this.a) * 0.1F;
      } else {
