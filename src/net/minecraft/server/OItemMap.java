...
//      "map_" + var1.h(); //find that in the reflection below
      ...
      if(var4 == null) {
         ...
         var4.a();
         var2.a(var3, (OWorldSavedData)var4);
      }
   ...
   public void a(OWorld var1, OEntity var2, OMapData var3) {
      if(var1.t.g == var3.d) {
         ...
         int var7 = var3.b;
         int var8 = var3.c;
         int var9 = OMathHelper.b(var2.bm - (double)var7) / var6 + var4 / 2;
         int var10 = OMathHelper.b(var2.bo - (double)var8) / var6 + var5 / 2;
         int var11 = 128 / var6;
         if(var1.t.e) {
            var11 /= 2;
         }
            ...
            if((var12 & 15) == (var3.g & 15)) {
               ...
               for(int var17 = var10 - var11 - 1; var17 < var10 + var11; ++var17) {
                  if(var12 >= 0 && var17 >= -1 && var12 < var4 && var17 < var5) {
                     ...
                     double var40 = (var31 - var15) * 4.0D / (double)(var6 + 4) + ((double)(var12 + var17 & 1) - 0.5D) * 0.4D;
                     byte var44 = 1;
                     if(var40 > 0.6D) {
                        var44 = 2;
                     }
                     ...
                     if(var34 > 0) {
                        ...
                        if(var46 == OMapColor.n) {
                           var40 = (double)var30 * 0.1D + (double)(var12 + var17 & 1) * 0.2D;
                           var44 = 1;
                           if(var40 < 0.5D) {
                              var44 = 2;
                           }
   ...
   public void d(OItemStack var1, OWorld var2, OEntityPlayer var3) {
      ...
      var2.a(var4, (OWorldSavedData)var5);
