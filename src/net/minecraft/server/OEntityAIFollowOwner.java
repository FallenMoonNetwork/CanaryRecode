...
public class OEntityAIFollowOwner extends OEntityAIBase {
   ...
   public OEntityAIFollowOwner(OEntityTamable var1, float var2, float var3, float var4) {
      super();
      this.d = var1;
      this.a = var1.bi;
      this.f = var2;
   ...
   public boolean a() {
      ...
      if(var1 == null) {
         ...
         return false;
      } else if(this.d.j(var1) < (double)(this.c * this.c)) {
         return false;
      } else {
         this.e = var1;
         return true;
   ...
   public boolean b() {
      return !this.g.e() && this.d.j(this.e) > (double)(this.b * this.b) && !this.d.v_();
   }
                  ...
                  for(int var4 = 0; var4 <= 4; ++var4) {
                     for(int var5 = 0; var5 <= 4; ++var5) {
                        if((var4 < 1 || var5 < 1 || var4 > 3 || var5 > 3) && this.a.e(var1 + var4, var3 - 1, var2 + var5) && !this.a.e(var1 + var4, var3, var2 + var5) && !this.a.e(var1 + var4, var3 + 1, var2 + var5)) {
                           this.d.c((double)((float)(var1 + var4) + 0.5F), (double)var3, (double)((float)(var2 + var5) + 0.5F), this.d.bs, this.d.bt);
                           this.g.f();
                           return;
                        }
                     }
