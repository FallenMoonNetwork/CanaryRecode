...
public class OMapGenStrongholdCrossing extends OMapGenStrongholdPiece {
   ...
   public OMapGenStrongholdCrossing(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.a = this.a(var2);
      this.g = var3;
   ...
   public void a(OStructurePiece var1, List var2, Random var3) {
      ...
      this.a((OMapGenStrongholdStairs2)var1, var2, var3, 5, 1);
      if(this.b) {
         this.b((OMapGenStrongholdStairs2)var1, var2, var3, var4, 1);
      }

      if(this.c) {
         this.b((OMapGenStrongholdStairs2)var1, var2, var3, var5, 7);
      }

      if(this.d) {
         this.c((OMapGenStrongholdStairs2)var1, var2, var3, var4, 1);
      }

      if(this.e) {
         this.c((OMapGenStrongholdStairs2)var1, var2, var3, var5, 7);
      }

   }

   public static OMapGenStrongholdCrossing a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, -4, -3, 0, 10, 9, 11, var5);
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OMapGenStrongholdCrossing(var6, var1, var7, var5):null;
   }
   ...
   public boolean a(OWorld var1, Random var2, OStructureBoundingBox var3) {
      if(this.a(var1, var3)) {
         ...
         this.a(var1, var3, 0, 0, 0, 9, 8, 10, true, var2, OMapGenStrongholdPieces.b());
         ...
         this.a(var1, var3, 1, 2, 1, 8, 2, 6, false, var2, OMapGenStrongholdPieces.b());
         this.a(var1, var3, 4, 1, 5, 4, 4, 9, false, var2, OMapGenStrongholdPieces.b());
         this.a(var1, var3, 8, 1, 5, 8, 4, 9, false, var2, OMapGenStrongholdPieces.b());
         this.a(var1, var3, 1, 4, 7, 3, 4, 9, false, var2, OMapGenStrongholdPieces.b());
         this.a(var1, var3, 1, 3, 5, 3, 3, 6, false, var2, OMapGenStrongholdPieces.b());
         this.a(var1, var3, 1, 3, 4, 3, 3, 4, OBlock.ak.bO, OBlock.ak.bO, false);
         this.a(var1, var3, 1, 4, 6, 3, 4, 6, OBlock.ak.bO, OBlock.ak.bO, false);
         this.a(var1, var3, 5, 1, 7, 7, 1, 8, false, var2, OMapGenStrongholdPieces.b());
