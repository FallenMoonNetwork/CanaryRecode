...
public class OVillage {
   ...
   public void a(int var1) {
      ...
      if(this.j < var2 && this.b.size() > 20 && this.a.r.nextInt(7000) == 0) {
         OVec3D var3 = this.a(OMathHelper.d((float)this.d.a), OMathHelper.d((float)this.d.b), OMathHelper.d((float)this.d.c), 2, 4, 2);
         if(var3 != null) {
            OEntityIronGolem var4 = new OEntityIronGolem(this.a);
            var4.c(var3.a, var3.b, var3.c);
            this.a.b((OEntity)var4);
            ++this.j;
         }
      }
   ...
   private OVec3D a(int var1, int var2, int var3, int var4, int var5, int var6) {
      for(int var7 = 0; var7 < 10; ++var7) {
         ...
         if(this.a(var8, var9, var10) && this.b(var8, var9, var10, var4, var5, var6)) {
            return OVec3D.b((double)var8, (double)var9, (double)var10);
         }
      }
   ...
   private void h() {
      List var1 = this.a.a(OEntityIronGolem.class, OAxisAlignedBB.b((double)(this.d.a - this.e), (double)(this.d.b - 4), (double)(this.d.c - this.e), (double)(this.d.a + this.e), (double)(this.d.b + 4), (double)(this.d.c + this.e)));
      this.j = var1.size();
   }

   private void i() {
      List var1 = this.a.a(OEntityVillager.class, OAxisAlignedBB.b((double)(this.d.a - this.e), (double)(this.d.b - 4), (double)(this.d.c - this.e), (double)(this.d.a + this.e), (double)(this.d.b + 4), (double)(this.d.c + this.e)));
      this.h = var1.size();
   }
