...
public class OBlockFence extends OBlock {
   ...
   public OAxisAlignedBB e(OWorld var1, int var2, int var3, int var4) {
      ...
      return OAxisAlignedBB.b((double)((float)var2 + var9), (double)var3, (double)((float)var4 + var11), (double)((float)var2 + var10), (double)((float)var3 + 1.5F), (double)((float)var4 + var12));
   }
