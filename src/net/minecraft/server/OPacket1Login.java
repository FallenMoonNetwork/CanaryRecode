...
public class OPacket1Login extends OPacket {
   ...
   public OPacket1Login(String var1, int var2, OEnumWorldType var3, int var4, int var5, byte var6, byte var7, byte var8) {
      super();
      this.b = var1;
      this.a = var2;
      this.c = var3;
   ...
   public void a(DataInputStream var1) throws IOException {
      ...
      this.c = OEnumWorldType.a(var2);
      if(this.c == null) {
         this.c = OEnumWorldType.b;
      }
