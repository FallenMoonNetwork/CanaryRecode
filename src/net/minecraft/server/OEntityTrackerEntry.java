...
import net.minecraft.server.OEntityThrownEnderpearl;
...
import net.minecraft.server.OPacket35EntityHeadLook;
...
public class OEntityTrackerEntry {
   ...
   public void a(List var1) {
      ...
      if(this.m++ % this.c == 0 || this.a.ce) {
         ...
         if(var7 >= -128 && var7 < 128 && var8 >= -128 && var8 < 128 && var9 >= -128 && var9 < 128 && this.u <= 400) {
            ...
            this.u = 0;
            this.a.bm = (double)var2 / 32.0D;
            this.a.bn = (double)var3 / 32.0D;
            this.a.bo = (double)var4 / 32.0D;
         ...
         if(this.t) {
            ...
            if(var21 > var19 * var19 || var21 > 0.0D && this.a.bp == 0.0D && this.a.bq == 0.0D && this.a.br == 0.0D) {
               ...
               this.k = this.a.bq;
               this.l = this.a.br;
               this.a((OPacket)(new OPacket28EntityVelocity(this.a.bd, this.j, this.k, this.l)));
            }
         }
         ...
         if(var23.a()) {
            this.b((OPacket)(new OPacket40EntityMetadata(this.a.bd, var23)));
         }

         int var24 = OMathHelper.d(this.a.ar() * 256.0F / 360.0F);
         if(Math.abs(var24 - this.i) >= 4) {
            this.a((OPacket)(new OPacket35EntityHeadLook(this.a.bd, (byte)var24)));
            this.i = var24;
         }
   ...
   public void a() {
      this.a((OPacket)(new OPacket29DestroyEntity(this.a.bd)));
   }
   ...
   public void b(OEntityPlayerMP var1) {
      if(var1 != this.a) {
         double var2 = var1.bm - (double)(this.d / 32);
         double var4 = var1.bo - (double)(this.f / 32);
         if(var2 >= (double)(-this.b) && var2 <= (double)this.b && var4 >= (double)(-this.b) && var4 <= (double)this.b) {
            if(!this.o.contains(var1)) {
               this.o.add(var1);
               var1.a.b(this.b());
               if(this.t) {
                  var1.a.b((OPacket)(new OPacket28EntityVelocity(this.a.bd, this.a.bp, this.a.bq, this.a.br)));
               }

               OItemStack[] var6 = this.a.y();
               if(var6 != null) {
                  for(int var7 = 0; var7 < var6.length; ++var7) {
                     var1.a.b((OPacket)(new OPacket5PlayerInventory(this.a.bd, var7, var6[var7])));
                  }
               }
               ...
               if(this.a instanceof OEntityPlayer) {
                  ...
                  if(var11.Z()) {
                     var1.a.b((OPacket)(new OPacket17Sleep(this.a, 0, OMathHelper.b(this.a.bm), OMathHelper.b(this.a.bn), OMathHelper.b(this.a.bo))));
                  }
               }
               ...
               if(this.a instanceof OEntityLiving) {
                  ...
                  while(var8.hasNext()) {
                     ...
                     var1.a.b((OPacket)(new OPacket41EntityEffect(this.a.bd, var9)));
                  }
               }
            }
         } else if(this.o.contains(var1)) {
            this.o.remove(var1);
            var1.a.b((OPacket)(new OPacket29DestroyEntity(this.a.bd)));
         }
   ...
   private OPacket b() {
      ...
      if(this.a instanceof OEntityItem) {
         ...
         var7.bm = (double)var8.b / 32.0D;
         var7.bn = (double)var8.c / 32.0D;
         var7.bo = (double)var8.d / 32.0D;
         return var8;
         ...
         } else if(this.a instanceof OEntityThrownEnderpearl) {
