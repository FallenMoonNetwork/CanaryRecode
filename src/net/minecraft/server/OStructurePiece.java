...
public abstract class OStructurePiece {
   ...
   protected OStructurePiece(int var1) {
      super();
      this.i = var1;
      this.h = -1;
   }
   ...
   public static OStructurePiece a(List var0, OStructureBoundingBox var1) {
      Iterator var2 = var0.iterator();

      OStructurePiece var3;
      do {
         if(!var2.hasNext()) {
            return null;
         }

         var3 = (OStructurePiece)var2.next();
   ...
   private static void a(Random var0, OStructurePieceTreasure[] var1, OTileEntityChest var2, int var3) {
      for(int var4 = 0; var4 < var3; ++var4) {
         OStructurePieceTreasure var5 = (OStructurePieceTreasure)OWeightedRandom.a(var0, (OWeightedRandomChoice[])var1);
