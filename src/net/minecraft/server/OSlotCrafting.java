...
public class OSlotCrafting extends OSlot {
   ...
   protected void b(OItemStack var1) {
      ...
      if(var1.c == OBlock.ay.bO) {
         this.f.a((OStatBase)OAchievementList.h, 1);
      } else if(var1.c == OItem.s.bP) {
         this.f.a((OStatBase)OAchievementList.i, 1);
      } else if(var1.c == OBlock.aB.bO) {
         this.f.a((OStatBase)OAchievementList.j, 1);
      } else if(var1.c == OItem.M.bP) {
         this.f.a((OStatBase)OAchievementList.l, 1);
      } else if(var1.c == OItem.T.bP) {
         this.f.a((OStatBase)OAchievementList.m, 1);
      } else if(var1.c == OItem.aY.bP) {
         this.f.a((OStatBase)OAchievementList.n, 1);
      } else if(var1.c == OItem.w.bP) {
         this.f.a((OStatBase)OAchievementList.o, 1);
      } else if(var1.c == OItem.q.bP) {
         this.f.a((OStatBase)OAchievementList.r, 1);
      } else if(var1.c == OBlock.bE.bO) {
         this.f.a((OStatBase)OAchievementList.D, 1);
      } else if(var1.c == OBlock.an.bO) {
         this.f.a((OStatBase)OAchievementList.F, 1);
      }
