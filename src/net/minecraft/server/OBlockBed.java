   ...
   public boolean a(OWorld var1, int var2, int var3, int var4, OEntityPlayer var5) {
      if(var1.F) {
         ...
         if(!var1.t.c()) {
            ...
            if(var1.a(var2, var3, var4) == this.bO) {
               var1.e(var2, var3, var4, 0);
               var8 = (var8 + (double)var2 + 0.5D) / 2.0D;
               var10 = (var10 + (double)var3 + 0.5D) / 2.0D;
               var12 = (var12 + (double)var4 + 0.5D) / 2.0D;
            }

            var1.a((OEntity)null, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F), 5.0F, true);
            return true;
         } else {
            if(e(var6)) {
