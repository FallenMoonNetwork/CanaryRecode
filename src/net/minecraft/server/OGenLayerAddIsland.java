...
public class OGenLayerAddIsland extends OGenLayer {

    public OGenLayerAddIsland(long var1, OGenLayer var3) {
        super(var1);
        this.a = var3;
    }
        ...
        for (int var11 = 0; var11 < var4; ++var11) {
            for (int var12 = 0; var12 < var3; ++var12) {
                ...
                if (var17 == 0 && (var13 != 0 || var14 != 0 || var15 != 0 || var16 != 0)) {
                    ...
                    } else if (var19 == OBiomeGenBase.n.M) {
                        var10[var12 + var11 * var3] = OBiomeGenBase.l.M;
                    } else {
                        var10[var12 + var11 * var3] = 0;
                    }
                } else if (var17 > 0 && (var13 == 0 || var14 == 0 || var15 == 0 || var16 == 0)) {
                    if (this.a(5) == 0) {
                        if (var17 == OBiomeGenBase.n.M) {
                            var10[var12 + var11 * var3] = OBiomeGenBase.l.M;
                        } else {
                            var10[var12 + var11 * var3] = 0;
                        }
