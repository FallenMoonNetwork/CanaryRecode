...
public class OMapGenStrongholdCorridor extends OMapGenStrongholdPiece {

   private final int a;


   public OMapGenStrongholdCorridor(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   ...
   public static OStructureBoundingBox a(List var0, Random var1, int var2, int var3, int var4, int var5) {
      ...
      OStructurePiece var7 = OStructurePiece.a(var0, var6);
      if(var7 == null) {
         return null;
      } else {
         if(var7.b().b == var6.b) {
