...
public class OBlockDetectorRail extends OBlockRail {
   ...
   private void f(OWorld var1, int var2, int var3, int var4, int var5) {
      ...
      boolean var7 = false;
      float var8 = 0.125F;
      List var9 = var1.a(OEntityMinecart.class, OAxisAlignedBB.b((double)((float)var2 + var8), (double)var3, (double)((float)var4 + var8), (double)((float)(var2 + 1) - var8), (double)((float)(var3 + 1) - var8), (double)((float)(var4 + 1) - var8)));
      if(var9.size() > 0) {
         var7 = true;
      }
