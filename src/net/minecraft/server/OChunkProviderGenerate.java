...
public class OChunkProviderGenerate implements OIChunkProvider {
      ...
      if(this.i == null) {
         ...
         for(int var8 = -2; var8 <= 2; ++var8) {
            for(int var9 = -2; var9 <= 2; ++var9) {
               float var10 = 10.0F / OMathHelper.c((float)(var8 * var8 + var9 * var9) + 0.2F);
      ...
      for(int var17 = 0; var17 < var5; ++var17) {
         for(int var18 = 0; var18 < var7; ++var18) {
            ...
            for(int var50 = 0; var50 < var6; ++var50) {
               ...
               var30 += var28 * 0.2D;
               var30 = var30 * (double)var6 / 16.0D;
               double var34 = (double)var6 / 2.0D + var30 * 4.0D;
               double var36 = 0.0D;
               ...
               var36 -= var38;
               if(var50 > var6 - 4) {
                  double var46 = (double)((float)(var50 - (var6 - 4)) / 3.0F);
   ...
   public void a(OIChunkProvider var1, int var2, int var3) {
      ...
      this.k.setSeed((long)var2 * var7 + (long)var3 * var9 ^ this.p.n());
      boolean var11 = false;
      if(this.q) {
