...
public class OMapGenVillageChurch extends OMapGenVillageStructureGen {

   private int a = -1;


   public OMapGenVillageChurch(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.g = var3;
   }
   ...
   public static OMapGenVillageChurch a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, 0, 0, 0, 5, 12, 9, var5);
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OMapGenVillageChurch(var6, var1, var7, var5):null;
   }
