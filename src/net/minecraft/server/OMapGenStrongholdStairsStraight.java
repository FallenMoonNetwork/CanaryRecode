...
public class OMapGenStrongholdStairsStraight extends OMapGenStrongholdPiece {

   private final OEnumDoor a;


   public OMapGenStrongholdStairsStraight(int var1, Random var2, OStructureBoundingBox var3, int var4) {
      super(var1);
      this.h = var4;
      this.a = this.a(var2);
      this.g = var3;
   ...
   public static OMapGenStrongholdStairsStraight a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
      OStructureBoundingBox var7 = OStructureBoundingBox.a(var2, var3, var4, -1, -7, 0, 5, 11, 8, var5);
      return a(var7) && OStructurePiece.a(var0, var7) == null?new OMapGenStrongholdStairsStraight(var6, var1, var7, var5):null;
   }
   ...
   public boolean a(OWorld var1, Random var2, OStructureBoundingBox var3) {
      if(this.a(var1, var3)) {
         ...
         this.a(var1, var3, 0, 0, 0, 4, 10, 7, true, var2, OMapGenStrongholdPieces.b());
