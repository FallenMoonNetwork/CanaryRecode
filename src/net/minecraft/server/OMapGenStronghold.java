...
import net.minecraft.server.OMapGenStrongholdStart;
...
public class OMapGenStronghold extends OMapGenStructure {
   ...
   protected OStructureStart b(int var1, int var2) {
      OMapGenStrongholdStart var3;
      for(var3 = new OMapGenStrongholdStart(this.d, this.c, var1, var2); var3.c().isEmpty() || ((OMapGenStrongholdStairs2)var3.c().get(0)).b == null; var3 = new OMapGenStrongholdStart(this.d, this.c, var1, var2)) {
         ;
      }
