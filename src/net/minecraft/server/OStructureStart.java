...
public abstract class OStructureStart {
   ...
   public void a(OWorld var1, Random var2, OStructureBoundingBox var3) {
      ...
      while(var4.hasNext()) {
         OStructurePiece var5 = (OStructurePiece)var4.next();
   ...
   protected void d() {
      ...
      while(var1.hasNext()) {
         OStructurePiece var2 = (OStructurePiece)var1.next();
         this.b.b(var2.b());
      }
   ...
   protected void a(OWorld var1, Random var2, int var3) {
      ...
      while(var7.hasNext()) {
         OStructurePiece var8 = (OStructurePiece)var7.next();
         var8.b().a(0, var6, 0);
      }
   ...
   protected void a(OWorld var1, Random var2, int var3, int var4) {
      ...
      while(var8.hasNext()) {
         OStructurePiece var9 = (OStructurePiece)var8.next();
         var9.b().a(0, var7, 0);
      }
