...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
    ...
    protected void a() {
        super.a();
        this.v().a(21, Byte.valueOf((byte)0));
    }
    ...
    public void a(boolean flag0) {
        this.v().b(21, Byte.valueOf((byte)(flag0 ? 1 : 0)));
    }
    ...
    public void c() {
        if (!this.q.I) {
            if (this.bT()) {
                ...
                if (this.ab.nextFloat() < 0.15F && this.af() && !this.a(Potion.n)) {
                    short1 = 16307;
                }
    ...
    public void a(EntityLivingBase entitylivingbase, float f0) {
        if (!this.bT()) {
            ...
            else if (entitylivingbase.aN() >= 8.0F && !entitylivingbase.a(Potion.u)) {
