...
public enum OEnumArmorMaterial {
    ...
    a("CLOTH", 0, 5, new int[] { 1, 3, 2, 1 }, 15), b("CHAIN", 1, 15, new int[] { 2, 5, 4, 1 }, 12), c("IRON", 2, 15, new int[] { 2, 6, 5, 2 }, 9), d("GOLD", 3, 7, new int[] { 2, 5, 3, 1 }, 25), e("DIAMOND", 4, 33, new int[] { 3, 8, 6, 3 }, 10);
    private int f;
    private int[] g;
    private int h;
    // $FF: synthetic field
