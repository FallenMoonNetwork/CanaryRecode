...
public class OComponentStrongholdLibrary extends OComponentStronghold {
    ...
    public OComponentStrongholdLibrary(int var1, Random var2, OStructureBoundingBox var3, int var4) {
        super(var1);
        this.h = var4;
        this.a = this.a(var2);
        this.g = var3;
    ...
    public static OComponentStrongholdLibrary a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        return new OComponentStrongholdLibrary(var6, var1, var7, var5);
    }
    ...
    public boolean a(OWorld var1, Random var2, OStructureBoundingBox var3) {
        if (this.a(var1, var3)) {
            ...
            this.a(var1, var3, 0, 0, 0, 13, var4 - 1, 14, true, var2, OStructureStrongholdPieces.b());
