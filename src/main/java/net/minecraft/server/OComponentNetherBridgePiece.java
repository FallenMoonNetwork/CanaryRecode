...
import net.minecraft.server.OComponentNetherBridgeEnd;
...
abstract class OComponentNetherBridgePiece extends OStructureComponent {
    ...
    private OComponentNetherBridgePiece a(OComponentNetherBridgeStartPiece var1, List var2, List var3, Random var4, int var5, int var6, int var7, int var8, int var9) {
        ...
        OComponentNetherBridgeEnd var17 = OComponentNetherBridgeEnd.a(var3, var4, var5, var6, var7, var8, var9);

        return var17;
    }

    private OStructureComponent a(OComponentNetherBridgeStartPiece var1, List var2, Random var3, int var4, int var5, int var6, int var7, int var8, boolean var9) {
        if (Math.abs(var4 - var1.b().a) <= 112 && Math.abs(var6 - var1.b().c) <= 112) {
            ...
            OComponentNetherBridgeEnd var10 = OComponentNetherBridgeEnd.a(var2, var3, var4, var5, var6, var7, var8);

            return var10;
        }
    }

    protected OStructureComponent a(OComponentNetherBridgeStartPiece var1, List var2, Random var3, int var4, int var5, boolean var6) {
        switch (this.h) {
        case 0:
    ...
    protected OStructureComponent b(OComponentNetherBridgeStartPiece var1, List var2, Random var3, int var4, int var5, boolean var6) {
        switch (this.h) {
        case 0:
    ...
    protected OStructureComponent c(OComponentNetherBridgeStartPiece var1, List var2, Random var3, int var4, int var5, boolean var6) {
        switch (this.h) {
        case 0:
