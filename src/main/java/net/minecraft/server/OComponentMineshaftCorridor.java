...
public class OComponentMineshaftCorridor extends OStructureComponent {
    ...
    public OComponentMineshaftCorridor(int var1, Random var2, OStructureBoundingBox var3, int var4) {
        super(var1);
        this.h = var4;
        this.g = var3;
    ...
    public static OStructureBoundingBox a(List var0, Random var1, int var2, int var3, int var4, int var5) {
        ...
        for (var7 = var1.nextInt(3) + 2; var7 > 0; --var7) {
            ...
            if (OStructureComponent.a(var0, var6) == null) {
                break;
            }
        }
    ...
    public void a(OStructureComponent var1, List var2, Random var3) {
        ...
        case 0:
            if (var5 <= 1) {
                OStructureMineshaftPieces.a(var1, var2, var3, this.g.a, this.g.b - 1 + var3.nextInt(3), this.g.f + 1, this.h, var4);
            } else if (var5 == 2) {
                OStructureMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b - 1 + var3.nextInt(3), this.g.f - 3, 1, var4);
            } else {
        ...
        case 1:
            if (var5 <= 1) {
                ...
                OStructureMineshaftPieces.a(var1, var2, var3, this.g.a, this.g.b - 1 + var3.nextInt(3), this.g.c - 1, 2, var4);
            } else {
        ...
        case 2:
            if (var5 <= 1) {
                ...
                OStructureMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b - 1 + var3.nextInt(3), this.g.c, 1, var4);
            } else {
        ...
        case 3:
            if (var5 <= 1) {
                ...
                OStructureMineshaftPieces.a(var1, var2, var3, this.g.d - 3, this.g.b - 1 + var3.nextInt(3), this.g.c - 1, 2, var4);
            } else {
                OStructureMineshaftPieces.a(var1, var2, var3, this.g.d - 3, this.g.b - 1 + var3.nextInt(3), this.g.f + 1, 0, var4);
            }
        }
        ...
        if (var4 < 8) {
            ...
            if (this.h != 2 && this.h != 0) {
                for (var6 = this.g.a + 3; var6 + 3 <= this.g.d; var6 += 5) {
                    var7 = var3.nextInt(5);
                    if (var7 == 0) {
                        OStructureMineshaftPieces.a(var1, var2, var3, var6, this.g.b, this.g.c - 1, 2, var4 + 1);
                    } else if (var7 == 1) {
                        OStructureMineshaftPieces.a(var1, var2, var3, var6, this.g.b, this.g.f + 1, 0, var4 + 1);
                    }
                }
            } else {
                for (var6 = this.g.c + 3; var6 + 3 <= this.g.f; var6 += 5) {
                    var7 = var3.nextInt(5);
                    if (var7 == 0) {
                        OStructureMineshaftPieces.a(var1, var2, var3, this.g.a - 1, this.g.b, var6, 1, var4 + 1);
                    } else if (var7 == 1) {
                        OStructureMineshaftPieces.a(var1, var2, var3, this.g.d + 1, this.g.b, var6, 3, var4 + 1);
                    }
                }
            }
        }
        ...
        if (this.a(var1, var3)) {
            ...
            for (var5 = 0; var5 < this.d; ++var5) {
                ...
                if (var2.nextInt(100) == 0) {
                    this.a(var1, var3, var2, 2, 0, var6 - 1, OStructureMineshaftPieces.a(), 3 + var2.nextInt(4));
                }

                if (var2.nextInt(100) == 0) {
                    this.a(var1, var3, var2, 0, 0, var6 + 1, OStructureMineshaftPieces.a(), 3 + var2.nextInt(4));
                }
