...
class OPlayerInstance {
    ...
    public void a(OEntityPlayerMP var1) {
        if (this.b.contains(var1)) {
            ...
            var1.g.add(this.e);
            var1.a.b((new OPacket50PreChunk(this.e.a, this.e.b, true)));
            this.b.add(var1);
            var1.f.add(this.e);
        }
    }
    ...
    public void b(OEntityPlayerMP var1) {
        if (this.b.contains(var1)) {
            ...
            if (var1.g.contains(this.e)) {
                var1.a.b((new OPacket50PreChunk(this.c, this.d, false)));
            }
    ...
    public void a() {
        ...
        if (this.g != 0) {
            ...
            if (this.g == 1) {
                ...
                this.a((new OPacket53BlockChange(var2, var3, var4, var1)));
                ...
                if (this.g == 64) {
                    var2 = this.c * 16;
                    var3 = this.d * 16;
                    this.a((new OPacket51MapChunk(var1.d(this.c, this.d), false, this.h)));
                    ...
                    this.a((new OPacket52MultiBlockChange(this.c, this.d, this.f, this.g, var1)));
