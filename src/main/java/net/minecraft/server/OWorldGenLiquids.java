...
public class OWorldGenLiquids extends OWorldGenerator {
    ...
    public OWorldGenLiquids(int var1) {
        super();
        this.a = var1;
    }
    ...
    public boolean a(OWorld var1, Random var2, int var3, int var4, int var5) {
        if (var1.a(var3, var4 + 1, var5) != OBlock.t.bO) {
            return false;
        } else if (var1.a(var3, var4 - 1, var5) != OBlock.t.bO) {
            return false;
        } else if (var1.a(var3, var4, var5) != 0 && var1.a(var3, var4, var5) != OBlock.t.bO) {
            return false;
        } else {
            int var6 = 0;
            ...
            if (var1.a(var3, var4, var5 - 1) == OBlock.t.bO) {
                ++var6;
            }
